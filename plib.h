...
char					*string_search_replace(char *str, char *sub,
							char *with);
char					*string_search_replace_all(char *str, char *sub,
							char *with);
int						string_set_at(char *str, unsigned int index, int ch);
char					*string_shuffle(char *str);
char					*string_slice(char *str1, unsigned int start,
							unsigned int end);
...
// we need more higher level function to transform a split progressively,
	mroe filter more mapping matching etc.

char					*string_search_first(char *str, char *sub);
char					*string_search_last(char *str, char *sub);
char					*string_map_match_first(char *str,
							char *(*f)(char *src));
char					*string_map_match_last(char *str,
							char *(*f)(char *src));
