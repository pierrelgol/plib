...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/08 11:02:10 by plgol.perso       #+#    #+#             */
/*   Updated: 2023/12/08 11:02:14 by plgol.perso      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	test2(void)
{
	...
	result = string_create(string_length("This is a test") + 1);
	str1 = " a test";
	str2 = " is";
	str3 = "This";
	...
	while (!stack_is_empty(stack))
		string_concat(result, stack_pop(stack));
