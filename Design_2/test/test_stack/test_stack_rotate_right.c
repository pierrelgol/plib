...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   test_stack_rotate_right.c                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: plgol.perso <pollivie@student.42.fr>       +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/08 12:34:43 by plgol.perso       #+#    #+#             */
/*   Updated: 2023/12/08 12:34:47 by plgol.perso      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int test1(void)
{
	...
	stack = 0;
	if (stack_rotate_right(stack, 42) != 0)
		return (FAIL);
	return (PASS);
}
