...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/05 14:26:25 by plgol.perso       #+#    #+#             */
/*   Updated: 2023/12/05 14:26:25 by plgol.perso      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	test1(void)
{
	...
	temp = list_create(str2);
	list_push_at(&list, temp, 1);
